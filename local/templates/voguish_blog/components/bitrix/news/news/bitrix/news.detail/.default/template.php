...
<?php if(!empty($arResult['PROPERTIES']['GALLERY']['VALUE'])) : ?>
    <?php foreach ($arResult['PROPERTIES']['GALLERY']['VALUE'] as $photo): ?>
        <a class="fancybox" href="<?=CFile::GetPath($photo)?>"><img  src="<?=CFile::GetPath($photo)?>" alt=""></a>
    <?php endforeach; ?>
<?php endif; ?>
<div class="artical-links">
    <ul>
        ...
        <li><a href="#"><small class="posts"> </small><span>View posts: <?=$arResult["SHOW_COUNTER"] ?? 0?></span></a></li>
